/*!
 * svgDraw - v0.1 - 2015-01-11
 * https://github.com/darkvovich/svgDraw
 */

var g, canvas, worms, colors = [],
    width = window.innerWidth, height = window.innerHeight,
    windowHalfX = window.innerWidth / 2, windowHalfY = window.innerHeight / 2,
    mouseX = 0, mouseY = 0, pmouseX = 0, pmouseY = 0, mousePressed = false, drawRate = 6, frameCount = 0,
    PI = Math.PI, TWO_PI = 2 * Math.PI, HALF_PI = Math.PI * 0.5;
